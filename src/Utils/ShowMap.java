...
public class ShowMap extends JPanel {
     ...
     * @param showGUI    if false, no map will be shown on screen. Good if you are
     ...
     *
     * @param grid     is the updated grid
     * @param robotRow is the current y-position (row) of the robot in the grid.
     ...
     *
     * @param grid     is the updated grid
     * @param maxVal   is the max value that a grid cell can have (e.g. 15 in
     *                 standard HIMM)
     * @param robotRow is the current y-position (row) of the robot in the grid.
     * @param robotCol is the current x-position (column) of the robot translated to
     *                 column in the grid.
