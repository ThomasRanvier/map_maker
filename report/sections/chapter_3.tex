...
By testing this same function on a real map built by the robot in MRDS we noticed that it is not efficient enough (it took around 5 to 10 seconds to get the frontiers).
